            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="text-[10px] text-txt-muted">
                  {machineType === 'NFA' ? 'Determinize NFA via power-set construction' : 'Requires NFA model mode'}
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="text-[10px] text-txt-muted">
                  {machineType === 'DFA' ? 'Minimize states via partition refinement' : 'Requires DFA model mode'}
                </div>
              </div>
            </div>
