...
export const REGISTERED_MODELS: Record<string, RegisteredModel> = {
  'nvidia/nemotron-3-super-120b-a12b': {
    ...
    description: '120B MoE model candidate for complex offline analysis and formal proof verification.',
  },
  ...
  'nvidia/nemotron-3.5-lightning-30b-a3b': {
    ...
    description: 'Fast 30B model suited for general educational chat and standard graph manipulations.',
  },
  ...
  'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning': {
    ...
    description: 'Primary high-speed 30B reasoning model with sub-second latency and strong graph/structured action capabilities.',
  },
